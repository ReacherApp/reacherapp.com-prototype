...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localizedAlternates(post.canonicalPath),
    openGraph: {
      title: post.title,
      description: post.description,
    ...
    <main className="min-h-screen overflow-hidden bg-[#f1f5ff] text-black">
      ...
      <article className="relative px-6 pb-[92px] pt-[132px]">
        ...
        <div className="relative z-10 mx-auto max-w-[1120px]">
          <Link href="/blog" className="inline-flex rounded-full bg-white/82 px-4 py-2 text-[13px] font-semibold text-[#3559e9] shadow-sm ring-1 ring-slate-200">
            Reacher Blog
          </Link>
