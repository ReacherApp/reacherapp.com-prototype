...
export const metadata: Metadata = {
  title: "TikTok Shop Growth Blog | Reacher",
  description:
    "Creator outreach, TikTok Shop affiliate growth, and social commerce playbooks from Reacher.",
      ...
      <section className="relative overflow-hidden px-6 pb-[76px] pt-[140px]">
        ...
        <div className="relative z-10 mx-auto max-w-[1220px]">
          <div className="text-center">
            <PageBadge>Reacher Blog</PageBadge>
            ...
            <p className="mx-auto mt-6 max-w-[720px] text-[19px] leading-[1.55] text-black/60">
              Practical guides for creator discovery, affiliate operations, social commerce campaigns, and scaling TikTok Shop revenue with Reacher.
            </p>
          </div>
          ...
          {featured ? (
            ...
            <div className="mx-auto mt-12 max-w-[720px] rounded-[24px] bg-white p-8 text-center shadow-[0_16px_46px_rgba(15,23,42,0.08)] ring-1 ring-slate-200">
              <p className="text-[18px] leading-7 text-black/60">No published articles yet.</p>
            </div>
          )}
